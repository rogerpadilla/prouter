...
c._started=!0;this._opts=a;this._opts.root=this._opts.root||"/";this._root=this._opts.root;this._wantsHashChange=!1!==this._opts.hashChange;this._wantsPushState=!!this._opts.pushState;this._hasPushState=!!(this._opts.pushState&&this._history&&this._history.pushState);a=this.getFragment();this._root=("/"+this._root+"/").replace(y,"/");this._hasPushState?f.addEventListener("popstate",this.checkUrl):this._wantsHashChange&&"onhashchange"in f&&f.addEventListener("hashchange",this.checkUrl);this._fragment=
