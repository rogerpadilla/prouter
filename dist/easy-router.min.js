...
d.started=!0;this.opts=a;this.opts.root=a.root||"/";this.root=this.opts.root;this._wantsHashChange=!1!==this.opts.hashChange;this._wantsPushState=!!this.opts.pushState;this._hasPushState=!!(this.opts.pushState&&this.history&&this.history.pushState);this.fragment=this.getFragment();this.root=("/"+this.root+"/").replace(x,"/");this._hasPushState?f.addEventListener("popstate",this.checkUrl):this._wantsHashChange&&"onhashchange"in f&&f.addEventListener("hashchange",this.checkUrl);if(this._wantsHashChange&&
...
""),c=c.replace(z,""),e=this.root+c;if(this.fragment===c)return!1;this.fragment=c;""===c&&"/"!==e&&(e=e.slice(0,-1));if(this._hasPushState)history[b.replace?"replaceState":"pushState"]({},n.title,e);else if(this._wantsHashChange)this._updateHash(c,b.replace);else return this.location.assign(e);return b.trigger?this.loadUrl(c):!1}},{key:"on",value:function(a,b){void 0===this.evtHandlers[a]&&(this.evtHandlers[a]=[]);this.evtHandlers[a].push(b);return this}},{key:"off",value:function(a,b){if(this.evtHandlers[a])for(var c=
