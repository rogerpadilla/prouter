...
this._evtHandlers[a]&&(this._evtHandlers[a]=[]);this._evtHandlers[a].push(e);return this}},{key:"off",value:function(a,e){if(this._evtHandlers[a])for(var b=this._evtHandlers[a],d=b.length,c=0;c<d;c++)if(b[c]===e){b.splice(c,1);0===b.length&&delete this._evtHandlers[a];break}return this}},{key:"_trigger",value:function(a){var e=this._evtHandlers[a];if(void 0===e)return!1;for(var b=Array.prototype.slice.call(arguments,1),d=0,c=e.length,h=[],g=void 0;d<c;d++)g=e[d].apply(this,b),h.push(g);for(;d<c;d++)if(!1===
h[d])return!1;return!0}},{key:"_updateHash",value:function(a,e){if(e){var b=this._location.href.replace(/(javascript:|#).*$/,"");this._location.replace(b+"#"+a)}else this._location.hash="#"+a}}]);return c}(),p=function(){function c(a){a=void 0===a?{}:a;k(this,c);this._evtHandlers={};this._opts=a;this._bindHandlers()}m(c,[{key:"addHandler",value:function(a){var e=c._routeToRegExp(a.route),b=this;c.history._addHandler(e,function(d,f){var h=c._extractParameters(e,d);f&&h.push(f);var g={"new":{fragment:d,
params:h}};b._oldCtrl&&(g.old={fragment:b._oldCtrl.fragment,params:b._oldCtrl.params});b._trigger("route:before",g);c.history._trigger("route:before",b,g);b._oldCtrl&&b._oldCtrl.off&&b._oldCtrl.off.apply(b._oldCtrl);a.on.apply(a,h);b._trigger("route:after",g);c.history._trigger("route:after",b,g);b._oldCtrl={off:a.off,fragment:d,params:h}});return this}},{key:"navigate",value:function(a,e,b){c.history.navigate(a,e,b);return this}},{key:"_bindHandlers",value:function(){if(this._opts.map)for(var a=
this._opts.map,e=a.length-1;0<=e;e--)this.addHandler(a[e])}}],[{key:"_routeToRegExp",value:function(a){a=a.replace(v,"\\$&").replace(s,"(?:$1)?").replace(t,function(a,b){return b?a:"([^/?]+)"}).replace(u,"([^?]*?)");return new RegExp("^"+a+"(?:\\?([\\s\\S]*))?$")}},{key:"_extractParameters",value:function(a,c){for(var b=a.exec(c).slice(1),d=b.length,k=[],h=0,g=void 0;h<d;h++)g=b[h],h===b.length-1&&g?k.push(g||null):g&&k.push(f.decodeURIComponent(g));return k}}]);return c}();p.prototype._trigger=n.prototype._trigger;
p.prototype.on=n.prototype.on;p.prototype.off=n.prototype.off;p.history=new n;l.History=n;l.Router=p});
