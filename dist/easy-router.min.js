...
b._old.handler.off&&b._old.handler.off.apply(b._old.handler),a.on.apply(a,g),b._trigger("route:after",k),d.history._trigger("route:after",b,k),b._old={fragment:e,params:h,handler:a})});return this}},{key:"navigate",value:function(a,c,b){d.history.navigate(a,c,b);return this}},{key:"_bindHandlers",value:function(){if(this._opts.map)for(var a=this._opts.map,c=a.length-1;0<=c;c--)this.addHandler(a[c])}}],[{key:"_routeToRegExp",value:function(a){a=a.replace(u,"\\$&").replace(r,"(?:$1)?").replace(s,function(a,
